...
/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
   MOTOR DA COPA â€” funÃ§Ãµes puras (sem DOM, sem rede). Tudo que decide "quem joga com quem",
   "quem estÃ¡ na frente" e "quem avanÃ§a" mora aqui, e a tela sÃ³ desenha o resultado.
   â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */
...
// cor de texto que lÃª bem em cima de `h`
...
// nome sem cor escolhida ganha uma cor estÃ¡vel (mesmo nome, mesma cor)
...
function siglaDe(nome, s) {
  ...
  const sem = String(nome || '').normalize('NFD').replace(/[Ì€-Í¯]/g, '');
...
/* ---------- catÃ¡logo: clubes do BrasileirÃ£o (a lista Ã© sÃ³ ponto de partida: cada time pode ser editado) ---------- */
const CATALOGO = [
  // SÃ©rie A (2025/26)
  { n: 'Flamengo', s: 'FLA', uf: 'RJ', c: ['#C8102E', '#111111'], ser: 'A', l: 'https://upload.wikimedia.org/wikipedia/commons/9/96/Clube_de_Regatas_do_Flamengo_logo.svg' },
  { n: 'Palmeiras', s: 'PAL', uf: 'SP', c: ['#0B6B3A', '#FFFFFF'], ser: 'A', l: 'https://upload.wikimedia.org/wikipedia/commons/6/60/SE_Palmeiras_2025_crest.png' },
  { n: 'Corinthians', s: 'COR', uf: 'SP', c: ['#161616', '#FFFFFF'], ser: 'A', l: 'https://upload.wikimedia.org/wikipedia/pt/b/b4/Corinthians_simbolo.png' },
  { n: 'SÃ£o Paulo', s: 'SAO', uf: 'SP', c: ['#E4002B', '#161616'], ser: 'A', l: 'https://upload.wikimedia.org/wikipedia/commons/f/f4/S%C3%A3o_Paulo_Futebol_Clube_logo_%282022%29.svg' },
  { n: 'Santos', s: 'SAN', uf: 'SP', c: ['#F2F2F2', '#161616'], ser: 'A', l: 'https://upload.wikimedia.org/wikipedia/commons/0/0e/Santos_Futebol_Clube_logo_%28with_stars_and_crown%29.png' },
  { n: 'RB Bragantino', s: 'RBB', uf: 'SP', c: ['#E4002B', '#FFFFFF'], ser: 'A', l: 'https://upload.wikimedia.org/wikipedia/pt/9/9e/RedBullBragantino.png' },
  { n: 'Mirassol', s: 'MIR', uf: 'SP', c: ['#F5C400', '#0A7A33'], ser: 'A', l: 'https://upload.wikimedia.org/wikipedia/commons/f/fd/Mirassol_Futebol_Clube_logo_%283_stars%29.png' },
  { n: 'Fluminense', s: 'FLU', uf: 'RJ', c: ['#7A1F3D', '#0B7A4B'], ser: 'A', l: 'https://upload.wikimedia.org/wikipedia/commons/1/12/Fluminense_Football_Club.svg' },
  { n: 'Botafogo', s: 'BOT', uf: 'RJ', c: ['#161616', '#FFFFFF'], ser: 'A', l: 'https://upload.wikimedia.org/wikipedia/commons/5/52/Botafogo_de_Futebol_e_Regatas_logo.svg' },
  { n: 'Vasco da Gama', s: 'VAS', uf: 'RJ', c: ['#161616', '#FFFFFF'], ser: 'A', l: 'https://upload.wikimedia.org/wikipedia/pt/8/8b/EscudoDoVascoDaGama.svg' },
  { n: 'AtlÃ©tico-MG', s: 'CAM', uf: 'MG', c: ['#161616', '#FFFFFF'], ser: 'A', l: 'https://upload.wikimedia.org/wikipedia/commons/4/41/Logo_of_Clube_Atl%C3%A9tico_Mineiro.svg' },
  { n: 'Cruzeiro', s: 'CRU', uf: 'MG', c: ['#0033A0', '#FFFFFF'], ser: 'A', l: 'https://upload.wikimedia.org/wikipedia/commons/9/90/Cruzeiro_Esporte_Clube_%28logo%29.svg' },
  { n: 'GrÃªmio', s: 'GRE', uf: 'RS', c: ['#0D80BF', '#161616'], ser: 'A', l: 'https://upload.wikimedia.org/wikipedia/commons/0/08/Gremio_logo.svg' },
  { n: 'Internacional', s: 'INT', uf: 'RS', c: ['#E4002B', '#FFFFFF'], ser: 'A', l: 'https://upload.wikimedia.org/wikipedia/commons/c/c5/Sport_Club_Internacional_logo.svg' },
  { n: 'Juventude', s: 'JUV', uf: 'RS', c: ['#0A7A33', '#FFFFFF'], ser: 'A', l: 'https://upload.wikimedia.org/wikipedia/commons/b/bf/Juventude_crest.png' },
  { n: 'Athletico-PR', s: 'CAP', uf: 'PR', c: ['#E4002B', '#161616'], ser: 'A', l: 'https://upload.wikimedia.org/wikipedia/commons/4/43/Athletico_Paranaense_%28Logo_2019%29.svg' },
  { n: 'Coritiba', s: 'CFC', uf: 'PR', c: ['#0A7A33', '#FFFFFF'], ser: 'A', l: 'https://upload.wikimedia.org/wikipedia/commons/b/bd/Coritiba_Foot_Ball_Club_logo.svg' },
  { n: 'Chapecoense', s: 'CHA', uf: 'SC', c: ['#0A7A33', '#FFFFFF'], ser: 'A', l: 'https://upload.wikimedia.org/wikipedia/commons/4/4e/Logo_Associa%C3%A7%C3%A3o_Chapecoense_de_Futebol.svg' },
  { n: 'Bahia', s: 'BAH', uf: 'BA', c: ['#0057B8', '#E4002B'], ser: 'A', l: 'https://upload.wikimedia.org/wikipedia/commons/2/2c/Esporte_Clube_Bahia_logo.svg' },
  { n: 'VitÃ³ria', s: 'VIT', uf: 'BA', c: ['#E4002B', '#161616'], ser: 'A', l: 'https://upload.wikimedia.org/wikipedia/commons/1/15/Esporte_Clube_Vit%C3%B3ria_%282024%29.svg' },
  { n: 'Fortaleza', s: 'FOR', uf: 'CE', c: ['#0033A0', '#E4002B'], ser: 'A', l: 'https://upload.wikimedia.org/wikipedia/commons/6/6d/Fortaleza_Esporte_Clube_logo.png' },
  { n: 'CearÃ¡', s: 'CEA', uf: 'CE', c: ['#161616', '#FFFFFF'], ser: 'A' },
  { n: 'Sport', s: 'SPO', uf: 'PE', c: ['#E4002B', '#161616'], ser: 'A', l: 'https://upload.wikimedia.org/wikipedia/pt/1/1a/Sport-clube-recife.svg' },
  { n: 'Remo', s: 'REM', uf: 'PA', c: ['#0A2A6B', '#FFFFFF'], ser: 'A', l: 'https://upload.wikimedia.org/wikipedia/commons/7/70/Clube_do_Remo.svg' },
  // SÃ©rie B e outros tradicionais
  { n: 'GoiÃ¡s', s: 'GOI', uf: 'GO', c: ['#0A7A33', '#FFFFFF'], ser: 'B' },
  { n: 'Vila Nova', s: 'VNO', uf: 'GO', c: ['#E4002B', '#FFFFFF'], ser: 'B' },
  { n: 'CuiabÃ¡', s: 'CUI', uf: 'MT', c: ['#0A7A33', '#F5C400'], ser: 'B' },
  { n: 'CriciÃºma', s: 'CRI', uf: 'SC', c: ['#F5C400', '#161616'], ser: 'B' },
  { n: 'AvaÃ­', s: 'AVA', uf: 'SC', c: ['#0057B8', '#FFFFFF'], ser: 'B' },
  { n: 'AmÃ©rica-MG', s: 'AME', uf: 'MG', c: ['#0A7A33', '#FFFFFF'], ser: 'B', l: 'https://upload.wikimedia.org/wikipedia/commons/6/6f/Escudo_oficial_do_Am%C3%A9rica_Futebol_Clube.svg' },
  { n: 'Athletic-MG', s: 'ATH', uf: 'MG', c: ['#161616', '#FFFFFF'], ser: 'B' },
  { n: 'OperÃ¡rio-PR', s: 'OPE', uf: 'PR', c: ['#161616', '#FFFFFF'], ser: 'B' },
  ...
  { n: 'FerroviÃ¡ria', s: 'FER', uf: 'SP', c: ['#7A1F3D', '#FFFFFF'], ser: 'B' },
  { n: 'CRB', s: 'CRB', uf: 'AL', c: ['#E4002B', '#FFFFFF'], ser: 'B' },
  { n: 'NÃ¡utico', s: 'NAU', uf: 'PE', c: ['#E4002B', '#FFFFFF'], ser: 'B' },
...
function novoEstado(titulo) {
  return {
    ...
    logo: 'ðŸ†', // emoji ou URL https de imagem
    cfg: { formato: 'grupos', nGrupos: 4, classificam: 2, terceiro: true },
    times: [],
    grupos: null, // [{ id:'A', ids:[idDoTime,...] }] depois do sorteio. Times ficam livres pra mover de grupo atÃ© a fase fechar
    gruposFechados: false, // true = classificaÃ§Ã£o por cotas travada (mata-mata jÃ¡ sorteado, ou temporada de pontos corridos encerrada)
    bracketInicial: null, // sÃ³ p/ formato 'grupos': ids (ou 'BYE') na ordem do 1Âº round, calculado ao fechar a fase de grupos
    seeds: null, // mata-mata direto: ids na ordem do chaveamento (cabeÃ§a de chave primeiro)
    jogos: [],
...
function novoTime(p) {
  ...
  return {
    ...
    cab: !!p.cab,
    ser: p.ser || '',
    // cotas vendidas (editadas pelo admin) e cartÃµes: sÃ£o do TIME, nÃ£o da rodada â€” sobrevivem a mudar de grupo ou editar nome/cor
    cotas: clamp(Math.floor(Number(p.cotas) || 0), 0, 999999),
    camarelo: clamp(Math.floor(Number(p.camarelo) || 0), 0, 20),
    cvermelho: !!p.cvermelho,
  };
}
// cartÃ£o vermelho OU 3+ amarelos = fora da classificaÃ§Ã£o, mesmo tendo mais cotas que os outros
const expulso = t => !!(t && (t.cvermelho || (t.camarelo || 0) >= 3));
// cada cartÃ£o amarelo tira 1 cota na hora de ranquear (nunca fica negativo)
...
function validarCfg(E) {
  ...
  if (cfg.formato === 'grupos') {
    if (T < 4) erros.push('Adicione pelo menos 4 times para jogar com fase de grupos.');
      ...
      if (cfg.nGrupos < 1 || cfg.nGrupos > Math.floor(T / 2)) erros.push(`Com ${T} times dÃ¡ para ter de 1 a ${Math.floor(T / 2)} grupos (mÃ­nimo de 2 times por grupo).`);
      else {
        const min = tamanhoMinGrupo(T, cfg.nGrupos);
        if (cfg.classificam < 1 || cfg.classificam > min) erros.push(`Cada grupo terÃ¡ pelo menos ${min} times: classifique de 1 a ${min} por grupo.`);
        else if (cfg.nGrupos * cfg.classificam < 2) erros.push('Ã‰ preciso classificar pelo menos 2 times para o mata-mata.');
      }
    }
...
/* ---------- sorteios ---------- */
// distribui os times pelos grupos: cabeÃ§as de chave primeiro (um por grupo), depois o resto, sempre no grupo mais vazio
...
/* ---------- classificaÃ§Ã£o de um grupo: por cotas lÃ­quidas (cotas âˆ’ cartÃµes amarelos), expulsos sempre por Ãºltimo ---------- */
...
/* ---------- mata-mata ---------- */
// ordem clÃ¡ssica de chaveamento: 1Ã—N, 4Ã—(N-3)... com os cabeÃ§as de chave sÃ³ se encontrando no fim
function padraoSeeds(N) {
  let arr = [1, 2];
  for (let n = 4; n <= N; n *= 2) { const nx = []; for (const s of arr) nx.push(s, n + 1 - s); arr = nx; }
  return N === 1 ? [1] : arr;
}
// as N posiÃ§Ãµes do 1Âº round, de cima para baixo (posiÃ§Ãµes vizinhas formam um jogo). `bye` = folga.
// Formato 'grupos': sÃ³ existe depois de fechar a fase de grupos (E.bracketInicial jÃ¡ vem calculado e fixo â€” cotas
// continuam editÃ¡veis depois disso sÃ³ pra registro, sem efeito no chaveamento jÃ¡ sorteado).
...
// disputa de 3Âº lugar precisa de dois perdedores de semifinal; com folga na semifinal (ex.: 3 classificados) nÃ£o existe
...
// quem se classifica de cada grupo (nÃ£o-expulsos, por cotas lÃ­quidas), numa lista Ãºnica pronta pro chaveamento:
// 1Âºs colocados primeiro (entre si por cotas), depois os 2Âºs etc. â€” mesma lÃ³gica de prioridade de um ranking geral
...
// arruma o 1Âº round pra ninguÃ©m do mesmo grupo se enfrentar de cara, quando dÃ¡ pra evitar trocando com outro confronto
function evitarMesmoGrupoNoPrimeiroJogo(rankComGrupo) {
  ...
  for (let i = 0; i < npares; i++) {
    ...
    for (const j of cand) {
      if (!slots[2 * j + 1]) continue; // nÃ£o troca com folga
      const a = slots[2 * i + 1], b = slots[2 * j + 1];
      slots[2 * i + 1] = b; slots[2 * j + 1] = a;
      if (!conflito(i) && !conflito(j)) break;
      slots[2 * i + 1] = a; slots[2 * j + 1] = b; // desfaz e tenta a prÃ³xima
    }
  }
  return slots.map(s => (s ? s.id : 'BYE'));
}

/* ---------- visÃ£o calculada: tudo que a tela precisa, derivado do estado ---------- */
...
// depois de qualquer mudanÃ§a: confere se cada jogo do mata-mata ainda Ã© entre os mesmos times de quando foi jogado.
// Se um resultado de cima mudou, o jogo de baixo (que dependia dele) Ã© zerado. Devolve os ids zerados.
function sanear(E) {
  const zerados = [];
...
/* ---------- aÃ§Ãµes sobre o estado (todas recebem um estado clonado e o alteram no lugar) ---------- */
function construirEstrutura(E) {
  // grupos/pontos: jogos (mata-mata) sÃ³ nascem quando a fase de grupos fecha (fecharFaseDeGrupos) â€” atÃ© lÃ¡ Ã© sÃ³ cotas/cartÃµes
...
/* ---------- cotas e cartÃµes (fase de grupos) ---------- */
function definirCotas(E, timeId, valor) {
  const t = E.times.find(x => x.id === timeId);
  if (!t) return { ok: false, erro: 'Time nÃ£o encontrado.' };
...
// sÃ³ pode mover enquanto a fase de grupos nÃ£o fechou â€” depois disso o mata-mata jÃ¡ foi sorteado com base na posiÃ§Ã£o anterior
function moverTimeDeGrupo(E, timeId, novoGrupoId) {
  if (!E.grupos) return { ok: false, erro: 'Ainda nÃ£o hÃ¡ grupos.' };
  if (E.gruposFechados) return { ok: false, erro: 'A fase de grupos jÃ¡ foi fechada.' };
  const alvo = E.grupos.find(g => g.id === novoGrupoId);
  if (!alvo) return { ok: false, erro: 'Grupo nÃ£o encontrado.' };
  E.grupos.forEach(g => { g.ids = g.ids.filter(id => id !== timeId); });
  alvo.ids.push(timeId);
  return { ok: true };
}
// fecha a classificaÃ§Ã£o por cotas e trava. 'grupos': monta o mata-mata com quem se classificou. 'pontos': sÃ³ define o campeÃ£o (o lÃ­der do grupo Ãºnico)
function fecharFaseDeGrupos(E) {
  if (!E.grupos || !E.grupos.length) return { ok: false, erro: 'Ainda nÃ£o hÃ¡ grupos.' };
  if (E.gruposFechados) return { ok: false, erro: 'A fase de grupos jÃ¡ estÃ¡ fechada.' };
...
// desfaz o fechamento (ex.: corrigir uma cota depois de fechar por engano). Cotas/cartÃµes e os grupos continuam como estÃ£o;
// se jÃ¡ tinha mata-mata sorteado, ele Ã© apagado (nÃ£o dÃ¡ pra "editar" um chaveamento que jÃ¡ saiu, sÃ³ refazer)
...
function definirJogo(E, id, patch) {
  ...
  if (!j) return { ok: false, erro: 'Jogo nÃ£o encontrado.' };
  const V = computarView(E);
  let a = j.a, b = j.b;
  if (j.fase === 'm') {
    const r = V.mata.get(j.id);
    if (r.bye) return { ok: false, erro: 'Este jogo Ã© uma folga: o time avanÃ§a direto.' };
    if (!r.a || !r.b) return { ok: false, erro: 'Aguardando a definiÃ§Ã£o dos dois times.' };
    a = r.a; b = r.b;
  }
  ...
  if (novo.ga !== novo.gb) { novo.pa = novo.pb = null; } // pÃªnaltis sÃ³ existem em empate
  let reaberto = false;
  if (novo.st === 'fim') {
    ...
    if (semPlacar || empateSemDesempate) {
      // pediu para encerrar: recusa. SÃ³ editou o placar de um jogo jÃ¡ encerrado: reabre em vez de perder a ediÃ§Ã£o
      if ('st' in patch) return { ok: false, erro: semPlacar ? 'Informe o placar antes de encerrar.' : 'Empate no mata-mata: informe o resultado dos pÃªnaltis para definir o vencedor.', pedirPenaltis: !semPlacar };
...
/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
   TEMA â€” presets + cores/estilo livres. O tema mora dentro do estado da copa (todo mundo vÃª o que o admin escolheu)
   e vira variÃ¡veis CSS na raiz da Copa e na camada de modais.
   â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */
const PRESETS = {
...
const FONTES = {
  ...
  serif: { n: 'ClÃ¡ssica', f: "'DM Sans',system-ui,sans-serif", d: "Georgia,'Times New Roman',serif" },
  mono: { n: 'TÃ©cnica', f: "ui-monospace,Consolas,'Courier New',monospace", d: "ui-monospace,Consolas,'Courier New',monospace" },
};
const CORES_CHAVES = ['bg', 'surf', 'text', 'accent', 'accent2'];

// junta o que o admin escolheu com os padrÃµes e descarta qualquer valor invÃ¡lido
...
// lÃª as cores do prÃ³prio Portal (tema claro/escuro dele) para o preset "Igual ao portal"
...
/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
   PERSISTÃŠNCIA â€” Supabase (tabela portal_copa_torneios) ou memÃ³ria (testes).
   Regras: leitura para todo mundo logado, escrita sÃ³ admin (RLS). `rev` evita que duas abas se sobrescrevam.
   â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */
...
function erroSB(error) {
  const e = new Error(
    error && (error.code === 'PGRST205' || /Could not find the table/i.test(error.message || ''))
      ? 'A tabela da Copa ainda nÃ£o existe no banco. Avise o administrador do sistema.'
...
const storeSB = {
  ...
  // grava sÃ³ se a versÃ£o do servidor ainda for a que a tela conhece; senÃ£o { conflito:true }
  ...
  _canal: null,
  // avisa a tela quando qualquer copa muda (a tela decide se Ã© a que estÃ¡ aberta)
  assinar(cb) {
    this.desassinar();
...
// versÃ£o em memÃ³ria: usada nos testes da interface (sem login e sem banco)
function criarStoreMem(opts) {
  ...
  const api = {
    ...
    async salvar(id, rev, estado, titulo) {
      await pausa();
      if (api.falhar) throw new Error('Sem conexÃ£o (simulada)');
...
/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
   INTERFACE â€” base: estado da tela, Ã­cones, escudos, modais, gravaÃ§Ã£o.
   â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */
...
// imagem de logo que nÃ£o carrega volta para o escudo desenhado
...
function rotuloOrigem(o) {
  if (!o) return 'â€”';
  switch (o.t) {
    case 'grupo': return `${o.pos}Âº do Grupo ${o.g}`;
    case 'slot': return `Classificado #${o.n}`;
    case 'bye': return 'Folga';
    case 'time': { const t = timePorId(o.id); return t ? t.n : 'â€”'; }
    case 'venc': case 'perd': {
...
// os dois lados de um jogo, jÃ¡ resolvidos: { a:{time,rot,bye}, b:{...} }
function ladosDe(j) {
...
const nomeRodadaJogo = j => (j.fase === 'g' ? `Grupo ${j.grupo} Â· Rodada ${j.rodada}` : (j.terceiro ? 'Disputa de 3Âº lugar' : nomeRodadaMata(j.rd, S.V.R)));
...
/* ---------- gravaÃ§Ã£o (autosave com versÃ£o) ---------- */
function marcarSync() {
  const el = $('.cx-sync', S.raiz);
  if (!el) return;
  const txt = { ok: S.admin ? 'Salvo' : 'Ao vivo', salvando: 'Salvandoâ€¦', sujo: 'AlteraÃ§Ãµes pendentesâ€¦', erro: 'Sem conexÃ£o. Tentando de novoâ€¦', conflito: 'Atualizado por outra pessoa', leitura: 'Somente leitura Â· ao vivo' }[S.salvo] || '';
  el.dataset.s = S.admin ? S.salvo : 'leitura';
  el.innerHTML = `<i></i>${esc(S.admin ? txt : 'Somente leitura Â· ao vivo')}`;
}
...
async function recarregarDoServidor(porConflito) {
  try {
    ...
    if (!row) { S.salvo = 'erro'; marcarSync(); avisar('Esta copa nÃ£o existe mais.', 'err'); return; }
    ...
    if (porConflito) avisar('Outra pessoa alterou a copa ao mesmo tempo. Carreguei a versÃ£o mais recente: refaÃ§a a sua Ãºltima mudanÃ§a.', 'err');
...
function migrar(E) {
  ...
  delete out.cfg.turnos; delete out.cfg.pontos; // extintos: grupo nÃ£o tem mais jogo, sÃ³ cotas/cartÃµes
...
// aplica uma mudanÃ§a no estado: clona, altera, limpa o que ficou sem sentido, pergunta se perder resultado, grava
async function mutar(fn, o) {
  ...
  if (perdidos.length && o.perguntar !== false) {
    ...
    const ok = await confirmar({ titulo: 'Isso vai limpar resultados', msg: `Essa mudanÃ§a altera ${perdidos.length} jogo(s) do mata-mata que jÃ¡ tinham resultado (${nomes}${perdidos.length > 4 ? 'â€¦' : ''}). Eles voltam para "agendado". Continuar?`, ok: 'Continuar', perigo: true });
    if (!ok) return { ok: false, cancelado: true };
  }
  empilharUndo(o.rot || 'AlteraÃ§Ã£o', o.coal);
  const antes = S.V;
  S.E = novo; recomputar();
...
// campeÃ£ nova? mostra a comemoraÃ§Ã£o (uma vez por campeÃ£)
function verCampeao() {
...
/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
   TELAS â€” cabeÃ§alho, etapas, abas, barra e as quatro visÃµes (grupos, mata-mata, jogos, times)
   â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */
function abasDaCopa() {
  const f = S.E.cfg.formato, out = [];
  if (f === 'grupos') out.push(['grupos', 'Grupos']);
  if (f === 'pontos') out.push(['grupos', 'ClassificaÃ§Ã£o']);
  if (f !== 'pontos') out.push(['mata', 'Mata-mata']);
  // pontos corridos nÃ£o tem jogo nenhum (Ã© sÃ³ cotas/cartÃµes): a aba "Jogos" nunca teria conteÃºdo
...
// enquanto a fase de grupos estÃ¡ aberta (cotas/cartÃµes rolando, sem mata-mata ainda) os cards do meio mostram
// Cotas/CartÃµes em vez de Jogos/Gols â€” nÃ£o tem "jogo" nenhum acontecendo nessa fase
...
function htmlCabecalho() {
  ...
  const meio = cotas
    ? `<div class="cx-stat"><b>${st.cotas}</b><span>Cotas</span></div><div class="cx-stat"><b>${st.camarelo + st.vermelho ? `<span style="color:${st.vermelho ? 'var(--cx-bad)' : 'var(--cx-warn)'}">${st.camarelo}${st.vermelho ? '+' + st.vermelho + 'ðŸŸ¥' : ''}</span>` : '0'}</b><span>CartÃµes</span></div>`
  ...
  return `<header class="cx-head">
    ...
    <div class="cx-sync" data-s="${S.admin ? S.salvo : 'leitura'}"><i></i>${S.admin ? 'Salvo' : 'Somente leitura Â· ao vivo'}</div>`;
}
function htmlEtapas() {
  ...
  return `<div class="cx-steps" aria-label="Etapas da copa">${passos.map((p, i) => `<div class="cx-step ${i < idx || (atual === 'campeao' && i === idx) ? 'on' : ''} ${i === idx && atual !== 'campeao' ? 'now' : ''}"><i>${i < idx || (atual === 'campeao') ? 'âœ“' : i + 1}</i>${esc(p[1])}</div>`).join('')}</div>`;
}
function htmlAbas() {
...
function htmlCampea() {
  ...
  if (!t) return '';
  return `<div class="cx-champ">${escudo(t)}<div><small>${S.E.cfg.formato === 'pontos' ? 'CampeÃ£ do campeonato' : 'CampeÃ£ da copa'}</small><b>${esc(t.n)}</b></div><span class="sp"></span>${S.admin ? `<button class="cx-btn sm" data-cx="historico">${ico('book')}Registrar no histÃ³rico</button>` : ''}<button class="cx-btn sm ghost" data-cx="celebrar">${ico('trophy')}Ver comemoraÃ§Ã£o</button></div>`;
}
...
function vazioSemEstrutura() {
  ...
  if (!S.E.times.length) return vazio('users', 'Comece pelos times', S.admin ? 'Adicione clubes do BrasileirÃ£o ou qualquer outro nome para montar a copa.' : 'Os times ainda nÃ£o foram cadastrados.', S.admin ? `<button class="cx-btn pri" data-cx="addTimes">${ico('plus')}Adicionar times</button>` : '');
  const txt = f === 'pontos' ? 'Um grupo sÃ³: acompanhe as cotas e cartÃµes de cada time e encerre quando quiser definir a campeÃ£.' : f === 'mata' ? 'O sorteio define o chaveamento do mata-mata.' : 'O sorteio distribui os times em grupos. LÃ¡ vocÃª acompanha cotas e cartÃµes e, quando quiser, fecha a fase e sorteia o mata-mata.';
  return vazio('shuffle', 'Tudo pronto para comeÃ§ar', S.admin ? txt : 'A copa ainda nÃ£o comeÃ§ou. Assim que o sorteio sair, ele aparece aqui.',
...
function htmlLinhaJogo(j, o) {
  ...
  else mid = `<b>${j.ga}</b><i>Ã—</i><b>${j.gb}</b>${isNum(j.pa) && isNum(j.pb) ? `<small>(${j.pa}-${j.pb})</small>` : ''}`;
...
/* ---------- grupos / classificaÃ§Ã£o: por Cotas (editadas pelo admin) e CartÃµes (amarelo tira 1 cota, 3 amarelos ou 1 vermelho = expulso) ---------- */
function htmlCartoes(r) {
  if (r.cvermelho) return `<span class="cx-cart verm" title="CartÃ£o vermelho â€” expulso">ðŸŸ¥</span>`;
  if (r.camarelo >= 3) return `<span class="cx-cart verm" title="3 cartÃµes amarelos â€” expulso">ðŸŸ¨Ã—${r.camarelo}</span>`;
  if (r.camarelo > 0) return `<span class="cx-cart am" title="${r.camarelo} cartÃ£o(Ãµes) amarelo(s) â€” tira ${r.camarelo} cota(s)">ðŸŸ¨Ã—${r.camarelo}</span>`;
  return `<span class="cx-cart">â€”</span>`;
}
function htmlTabelaGrupo(g, gi) {
  ...
  const linhas = tab.map((r, i) => {
    ...
    const conteudo = `<td><span class="cx-rk">${r.expulso ? 'Ã—' : i + 1}</span></td><td class="nm"><div class="cx-tm">${escudo(t)}<span>${esc(t.n)}</span>${r.expulso ? '<small class="cx-exptag">EXPULSO</small>' : ''}</div></td><td><b>${r.cotas}</b></td><td>${htmlCartoes(r)}</td>`;
    // Ã­cone sempre visÃ­vel (nÃ£o sÃ³ no hover) pra ficar Ã³bvio que dÃ¡ pra tocar/clicar, inclusive no celular
    return S.admin
      ? `<tr class="${cls} clic" data-cx="editCotas" data-id="${esc(r.id)}" tabindex="0" role="button" aria-label="Editar cotas e cartÃµes de ${esc(t.n)}">${conteudo}<td class="cx-editcol">${ico('edit')}</td></tr>`
      : `<tr class="${cls}">${conteudo}</tr>`;
  }).join('');
  return `<article class="cx-card cx-hov cx-gcard" style="--gc:${cor};--i:${gi}">
      <div class="cx-ghead"><span class="cx-gbadge">${pontos ? 'â˜…' : esc(g.id)}</span><b>${pontos ? 'Tabela do campeonato' : 'Grupo ' + esc(g.id)}</b><span class="pr">${tab.length} time${tab.length !== 1 ? 's' : ''}</span></div>
      <table class="cx-tbl"><thead><tr><th>#</th><th>Time</th><th>Cotas</th><th>CartÃµes</th>${S.admin ? '<th></th>' : ''}</tr></thead><tbody>${linhas}</tbody></table>
    </article>`;
}
function vGrupos() {
  const E = S.E;
  ...
  const info = pontos ? '' : `<div class="cx-sec">${E.grupos.length} grupo${E.grupos.length > 1 ? 's' : ''} Â· classificam ${E.cfg.classificam} por grupo</div>`;
  const comIcone = S.admin && !(!pontos && E.gruposFechados); // sÃ³ quando o lÃ¡pis de editar realmente aparece nas linhas
  const dica = S.admin
    ? (pontos ? 'Toque no lÃ¡pis pra ajustar cotas e cartÃµes de um time.' : (E.gruposFechados ? 'A fase de grupos estÃ¡ fechada: cotas e cartÃµes continuam editÃ¡veis pra registro, mas nÃ£o mudam mais o mata-mata jÃ¡ sorteado.' : 'Toque no lÃ¡pis pra ajustar cotas, cartÃµes, ou mover o time pra outro grupo.'))
    : (pontos ? 'Quem estÃ¡ na frente em cotas lidera.' : 'Faixa verde = posiÃ§Ã£o que classifica para o mata-mata.');
...
function htmlCartaoMata(j, i) {
  ...
  if (r.bye) {
    ...
    return `<div class="cx-mc bye" style="--i:${i}"><div class="ln ${quem.time ? 'w' : 'tbd'}">${escudo(quem.time)}<span class="nm">${esc(quem.time ? quem.time.n : quem.rot)}</span></div><div class="ln tbd"><span class="nm">Folga Â· avanÃ§a direto</span></div></div>`;
  }
...
function htmlPodio() {
  ...
  return `<div class="cx-podio">${item('gold', '1Âº Â· CampeÃ£', rf.venc)}${item('', '2Âº Â· Vice', rf.perd)}${rt && rt.done ? item('', '3Âº lugar', rt.venc) : ''}</div>`;
}
function vMata() {
  const E = S.E, V = S.V;
  ...
  const bloco3 = terc ? `<div class="cx-third"><h4>Disputa de 3Âº lugar</h4>${htmlCartaoMata(terc, 0)}</div>` : '';
...
function rodadasDisponiveis() {
  ...
  if (E.jogos.some(j => j.terceiro)) out.push({ k: 'm3', n: 'Disputa de 3Âº lugar', f: j => j.terceiro });
  return out;
}
...
function vTimes() {
  ...
  const cards = ord.map((t, i) => {
    ...
    const tags = `${t.cab ? `<span class="cx-tag">â˜… CabeÃ§a</span>` : ''}${g ? `<span class="cx-tag g" style="--gc:${corGrupo(g.i)}">Grupo ${esc(g.id)}</span>` : ''}`;
    const conteudo = `${escudo(t)}<b>${esc(t.n)}</b><small>${esc([t.sub, t.ser ? 'SÃ©rie ' + t.ser : ''].filter(Boolean).join(' Â· ') || t.s)}</small>${tags ? `<div class="tags">${tags}</div>` : ''}`;
    return S.admin
  ...
  const aviso = S.admin && temEstrutura(E) ? '<div class="cx-warn">' + ico('alert') + '<div>O sorteio jÃ¡ foi feito: dÃ¡ para editar nome, cores e escudo de cada time, mas incluir ou tirar times exige refazer o sorteio (menu Mais â†’ Refazer sorteio).</div></div>' : '';
...
function htmlSemCopa() {
  return `<div class="cx-body">${S.erro ? vazio('alert', 'NÃ£o foi possÃ­vel abrir a copa', S.erro, `<button class="cx-btn" data-cx="recarregar">${ico('refresh')}Tentar de novo</button>`)
    : S.admin ? vazio('trophy', 'Nenhuma copa criada', 'Monte a primeira copa: escolha os times (do BrasileirÃ£o ou outros nomes), o formato e o tema.', `<button class="cx-btn pri" data-cx="novaCopa">${ico('plus')}Criar copa</button>${S.lista.length ? `<button class="cx-btn" data-cx="copas">${ico('layers')}Copas anteriores</button>` : ''}`)
...
function render() {
  ...
  aplicarTemaAtual();
  if (S.carregando) { inner.innerHTML = `<div class="cx-body"><div class="cx-empty"><div class="ic">${ico('trophy')}</div><p>Carregando a copaâ€¦</p></div></div>`; return; }
...
/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
   MODAIS â€” jogo, times, configuraÃ§Ã£o, sorteio, copas, campeÃ£
   â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */

/* ---------- imagens (escudo prÃ³prio) ---------- */
function comprimirImagem(file, max) {
  return new Promise((res, rej) => {
    ...
    im.onload = () => {
      ...
      cv.toBlob(b => (b ? res(b) : rej(new Error('NÃ£o foi possÃ­vel converter a imagem.'))), 'image/webp', 0.86);
    };
    im.onerror = () => { URL.revokeObjectURL(url); rej(new Error('Arquivo de imagem invÃ¡lido.')); };
    im.src = url;
  });
}
async function enviarImagem(file, pasta) {
  ...
  if (file.size > 8 * 1024 * 1024) throw new Error('Imagem muito grande (mÃ¡x. 8 MB).');
  if (typeof sb === 'undefined' || !sb.storage) throw new Error('Envio de imagem indisponÃ­vel aqui. Cole o endereÃ§o (https) da imagem.');
...
/* â•â•â•â•â•â•â•â•â• JOGO â•â•â•â•â•â•â•â•â• */
...
function htmlJogo() {
  ...
  const num = lado => (j.st === 'ag' ? 'â€“' : (lado === 'a' ? j.ga : j.gb));
  const adj = lado => (edita ? `<div class="cx-adj"><button data-cx="gol" data-l="${lado}" data-d="-1" aria-label="Menos um gol" ${j.st === 'ag' || !(lado === 'a' ? j.ga : j.gb) ? 'disabled' : ''}>âˆ’</button><button data-cx="gol" data-l="${lado}" data-d="1" aria-label="Mais um gol">+</button></div>` : '');
  const bump = l => (S.jogoAberto.bump === l ? 'bump' : '');
  const empateMata = j.fase === 'm' && j.st !== 'ag' && j.ga === j.gb;
  const pen = empateMata ? `<div class="cx-pen"><span class="cx-lbl">PÃªnaltis</span><input class="cx-in" type="number" min="0" max="99" inputmode="numeric" data-cxi="pen" data-l="a" value="${isNum(j.pa) ? j.pa : ''}" ${edita ? '' : 'disabled'} aria-label="PÃªnaltis do primeiro time"><span style="color:var(--cx-mut)">Ã—</span><input class="cx-in" type="number" min="0" max="99" inputmode="numeric" data-cxi="pen" data-l="b" value="${isNum(j.pb) ? j.pb : ''}" ${edita ? '' : 'disabled'} aria-label="PÃªnaltis do segundo time"></div>` : '';
  ...
  const info = edita
    ? `<div class="cx-row" style="margin-top:14px"><div class="cx-f" style="margin:0"><label>Data e hora</label><input class="cx-in" type="datetime-local" data-cxi="jdt" value="${esc(j.dt || '')}"></div><div class="cx-f" style="margin:0"><label>Local</label><input class="cx-in" maxlength="60" data-cxi="jloc" value="${esc(j.loc || '')}" placeholder="EstÃ¡dio, salaâ€¦"></div></div>`
    : (j.dt || j.loc ? `<p class="cx-hint" style="text-align:center;margin:8px 0 0">${esc([dataCurta(j.dt), j.loc].filter(Boolean).join(' Â· '))}</p>` : '');
  const aviso = S.admin && !definido ? `<div class="cx-warn">${ico('alert')}<div>${r && r.bye ? 'Este jogo Ã© uma folga: o time avanÃ§a direto.' : 'Aguardando a definiÃ§Ã£o dos dois times. Assim que os jogos anteriores terminarem, o placar poderÃ¡ ser lanÃ§ado.'}</div></div>` : '';
  const i = S.jogoAberto.ids.indexOf(j.id), tem = S.jogoAberto.ids.length > 1;
  const nav = tem ? `<div class="cx-nav"><button class="cx-ib" data-cx="jogoNav" data-d="-1" aria-label="Jogo anterior" ${i <= 0 ? 'disabled style="opacity:.35"' : ''}>${ico('left')}</button><button class="cx-ib" data-cx="jogoNav" data-d="1" aria-label="PrÃ³ximo jogo" ${i >= S.jogoAberto.ids.length - 1 ? 'disabled style="opacity:.35"' : ''}>${ico('right')}</button></div><span class="cx-hint">${i + 1}/${S.jogoAberto.ids.length}</span>` : '';
  return `<div class="cx-modal" role="dialog" aria-modal="true" aria-label="Jogo">
    <div class="cx-mh"><div style="flex:1;min-width:0"><small>${esc(nomeRodadaJogo(j))}</small><h3>${esc((L.a.time ? L.a.time.n : L.a.rot) + ' Ã— ' + (L.b.time ? L.b.time.n : L.b.rot))}</h3></div>${pill}<button class="cx-ib" data-cx="fechar" aria-label="Fechar">${ico('x')}</button></div>
    <div class="cx-mb">${aviso}<div class="cx-board">${side(L.a, 'a')}<div class="cx-score"><div><div class="n ${bump('a')}">${num('a')}</div>${adj('a')}</div><span class="x">Ã—</span><div><div class="n ${bump('b')}">${num('b')}</div>${adj('b')}</div></div>${side(L.b, 'b')}</div>${pen}${acoes ? `<div style="display:flex;gap:8px;justify-content:center;flex-wrap:wrap">${acoes}</div>` : ''}${info}</div>
    <div class="cx-mf">${nav}<span class="sp"></span><button class="cx-btn" data-cx="fechar">Fechar</button></div></div>`;
}

/* â•â•â•â•â•â•â•â•â• TIMES â•â•â•â•â•â•â•â•â• */
...
function htmlFormTime(t, idp) {
  ...
  return `<div class="cx-prev"><span id="${idp}-prev">${escudo(t)}</span><div style="min-width:0"><b id="${idp}-pn" style="font-size:15px">${esc(t.n || 'Nome do time')}</b><div class="cx-hint">Assim o time aparece nas tabelas e no chaveamento.</div></div></div>
    ...
    <div class="cx-f"><label for="${idp}-sub">Legenda (opcional)</label><input class="cx-in" id="${idp}-sub" maxlength="40" value="${esc(t.sub || '')}" placeholder="Cidade, setor, apelidoâ€¦" autocomplete="off"></div>
    <div class="cx-f"><label for="${idp}-logo">Imagem do escudo (opcional)</label><div class="cx-photo"><input class="cx-in" id="${idp}-logo" value="${esc(t.logo || '')}" placeholder="https://â€¦ ou envie um arquivo" data-cxi="tprev" data-p="${idp}" autocomplete="off"><button class="cx-btn sm" type="button" data-cx="upload" data-alvo="${idp}-logo" data-pasta="copa-times">${ico('upload')}Enviar</button></div></div>
    <button type="button" class="cx-tog ${t.cab ? 'on' : ''}" data-cx="togCab" id="${idp}-cab" style="background:none;border:0;color:inherit;font:inherit;text-align:left;width:100%"><span class="sw"></span><span><b>CabeÃ§a de chave</b><span class="d">No sorteio, cabeÃ§as de chave ficam em grupos diferentes (ou nas primeiras posiÃ§Ãµes da chave).</span></span></button>`;
}
...
// seletor: BrasileirÃ£o | lista de nomes | um time
function abrirPicker() {
  if (!S.admin) return;
  if (temEstrutura(S.E)) return avisar('O sorteio jÃ¡ foi feito. Para incluir times, refaÃ§a o sorteio (menu Mais).', 'err');
...
function htmlPicker() {
  const p = S.picker;
  const seg = `<div class="cx-seg" style="margin-bottom:16px"><button class="${p.modo === 'br' ? 'on' : ''}" data-cx="pickModo" data-m="br">BrasileirÃ£o</button><button class="${p.modo === 'lista' ? 'on' : ''}" data-cx="pickModo" data-m="lista">Lista de nomes</button><button class="${p.modo === 'um' ? 'on' : ''}" data-cx="pickModo" data-m="um">Um time</button></div>`;
  let corpo;
  if (p.modo === 'br') {
    corpo = `${seg}<div class="cx-row" style="align-items:flex-end"><div class="cx-f" style="margin:0;flex:2"><label for="cx-busca">Buscar</label><input class="cx-in" id="cx-busca" data-cxi="pickBusca" placeholder="Nome ou estado (ex.: SP)" value="${esc(p.busca)}" autocomplete="off"></div><div class="cx-chips" style="margin:0;flex:none">${[['todos', 'Todos'], ['A', 'SÃ©rie A'], ['B', 'SÃ©rie B']].map(([k, n]) => `<button class="cx-chip ${p.serie === k ? 'on' : ''}" data-cx="pickSerie" data-s="${k}">${n}</button>`).join('')}</div></div>
      <div style="display:flex;gap:8px;margin-top:12px;align-items:center;flex-wrap:wrap"><button class="cx-btn sm" data-cx="pickTodos">Selecionar os que aparecem</button><button class="cx-btn sm ghost" data-cx="pickLimpar">Limpar seleÃ§Ã£o</button><span class="cx-hint" id="cx-pick-n"></span></div>
      <div class="cx-cat" id="cx-cat"></div><p class="cx-hint" style="margin-top:14px">Times do BrasileirÃ£o jÃ¡ vÃªm com o brasÃ£o oficial. DÃ¡ para trocar a imagem, cor e sigla depois de adicionar.</p>`;
    ...
    corpo = `${seg}<div class="cx-f"><label for="cx-lista">Um nome por linha</label><textarea class="cx-in" id="cx-lista" data-cxi="pickLista" rows="9" placeholder="Ana Souza&#10;Carlos Lima; CAR&#10;Equipe Alfa; ALF; #0d80bf; #ffffff" spellcheck="false"></textarea></div>
      <p class="cx-hint">Serve para pessoas, equipes ou qualquer outro nome. Opcional depois do nome, separado por <b>;</b>: sigla, cor principal e cor do contorno. Sem cor escolhida, cada nome ganha uma cor prÃ³pria.</p><p class="cx-hint" id="cx-lista-n" style="margin-top:8px"></p>`;
  } else {
...
function renderCatalogo() {
  ...
  box.innerHTML = lista.map(({ c, i }) => {
    const t = novoTime({ n: c.n, s: c.s, c1: c.c[0], c2: c.c[1], logo: c.l });
    return `<button class="cx-pick ${jaTem(c.n) ? 'has' : (p.sel.has(i) ? 'on' : '')}" data-cx="pickCat" data-i="${i}">${escudo(t)}<span><b>${esc(c.n)}</b><small>${esc(c.uf)} Â· SÃ©rie ${esc(c.ser)}</small></span></button>`;
...
function atualizarBotaoPicker() {
  ...
  else if (p.modo === 'lista') { const l = parseLista(($('#cx-lista') || {}).value); n = l.filter(x => !jaTem(x.n)).length; if (contL) contL.textContent = l.length ? `${n} nome(s) novo(s) para adicionar${l.length - n ? ` Â· ${l.length - n} jÃ¡ estÃ£o na copa` : ''}` : ''; }
  else n = 1;
...
async function confirmarPicker() {
  ...
  if (p.modo === 'br') novos = [...p.sel].map(i => ({ n: CATALOGO[i].n, s: CATALOGO[i].s, c1: CATALOGO[i].c[0], c2: CATALOGO[i].c[1], ser: CATALOGO[i].ser, sub: CATALOGO[i].uf, logo: CATALOGO[i].l }));
  ...
  if (S.E.times.length + novos.length > 64) return avisar('O limite Ã© de 64 times por copa.', 'err');
...
function abrirEditTime(id) {
  ...
  abrirModal(moldura({
    ...
    corpo: htmlFormTime(t, 'cx-e') + (trava ? `<div class="cx-hint">O sorteio jÃ¡ foi feito, entÃ£o o time nÃ£o pode ser excluÃ­do agora (refaÃ§a o sorteio pelo menu Mais).</div>` : ''),
...
async function salvarTime(id) {
  ...
  if (S.E.times.some(t => t.id !== id && t.n.toLowerCase() === f.n.toLowerCase())) return avisar('JÃ¡ existe um time com esse nome.', 'err');
  const r = await mutar(E => {
    const t = E.times.find(x => x.id === id); if (!t) return { ok: false, erro: 'Time nÃ£o encontrado.' };
    // preserva cotas/cartÃµes: editar nome/cor nÃ£o pode apagar o que jÃ¡ foi apurado pro time
...
/* â•â•â•â•â•â•â•â•â• COTAS E CARTÃ•ES (fase de grupos) â•â•â•â•â•â•â•â•â• */
...
function htmlEditarCotas() {
  ...
  const corpo = `<div class="cx-prev">${escudo(t)}<div style="min-width:0"><b style="font-size:15px">${esc(t.n)}</b>${grupoAtual ? `<div class="cx-hint">Grupo ${esc(grupoAtual.id)}</div>` : ''}</div></div>
    ${exp ? `<div class="cx-warn bad">${ico('alert')}<div>Expulso â€” nÃ£o entra na classificaÃ§Ã£o, mesmo tendo mais cotas que os outros.</div></div>` : ''}
    ...
    <div class="cx-lbl" style="margin:14px 0 8px">CartÃµes</div>
    <div class="cx-row" style="align-items:flex-end;flex-wrap:wrap">
      <div class="cx-f" style="margin:0;min-width:170px"><label>Amarelos <span class="cx-hint" style="font-weight:400">Â· cada um tira 1 cota, 3 expulsam</span></label>
        <div class="cx-step2"><button type="button" data-cx="cotCartaoAm" data-d="-1" aria-label="Menos um amarelo">âˆ’</button><output>${t.camarelo}</output><button type="button" data-cx="cotCartaoAm" data-d="1" aria-label="Mais um amarelo">+</button></div>
      </div>
      <button type="button" class="cx-btn ${t.cvermelho ? 'bad' : ''}" data-cx="cotCartaoVerm">ðŸŸ¥ ${t.cvermelho ? 'Remover cartÃ£o vermelho' : 'Aplicar cartÃ£o vermelho'}</button>
    </div>
  ...
  return moldura({ titulo: 'Cotas e cartÃµes', sub: t.n, cls: 'sm', corpo, rodape: `<button class="cx-btn pri blk" data-cx="fechar">Pronto</button>` });
}
...
/* â•â•â•â•â•â•â•â•â• FECHAR A FASE DE GRUPOS â•â•â•â•â•â•â•â•â• */
function abrirFecharGrupos() {
  ...
  if (pontos) {
    ...
    confirmar({ titulo: 'Encerrar temporada?', msg: nome ? `"${nome}" estÃ¡ na lideranÃ§a e vira campeÃ£. DÃ¡ pra reabrir depois, se precisar corrigir algo.` : 'Ainda nÃ£o hÃ¡ um lÃ­der definido (empate ou sÃ³ times expulsos).', ok: 'Encerrar', perigo: true })
...
function htmlFecharGrupos() {
  ...
  const corpo = `<p class="cx-hint" style="margin:0 0 14px">Isso trava as cotas e cartÃµes de agora e sorteia o mata-mata com quem se classificou. DÃ¡ pra reabrir depois (menu Mais) se precisar corrigir algo, mas o mata-mata jÃ¡ sorteado Ã© apagado.</p>
    ...
    return `<li style="--i:${gi * 4 + i};opacity:${r.expulso ? '.5' : '1'}">${escudo(t)}<span>${esc(t.n)}${r.expulso ? ' Â· expulso' : ''}</span><b style="color:${vai ? 'var(--cx-ok)' : 'var(--cx-mut)'};font-family:var(--cx-font-d);font-size:13px;flex:none">${r.cotas}</b></li>`;
  }).join('')}</ul></div>`).join('')}</div>
    <p class="cx-hint" style="margin-top:12px"><span style="color:var(--cx-ok)">â–</span> vai pro mata-mata (classificam ${E.cfg.classificam} por grupo).</p>`;
...
function abrirConfig() {
  if (!S.admin) return;
  const E = S.E;
  S.cfgDraft = { titulo: E.titulo, subtitulo: E.subtitulo, logo: E.logo || 'ðŸ†', cfg: clone(E.cfg) };
...
function resumoCfg(d) {
  ...
  if (c.formato === 'pontos') return `${T} times, todos no mesmo grupo. Cotas e cartÃµes definem quem lidera; vocÃª encerra a temporada quando quiser.`;
  if (c.formato === 'mata') { const N = nextPow2(Math.max(T, 2)); return `${T} times em chave de ${N} vagas${N > T ? ` (${N - T} folga${N - T > 1 ? 's' : ''} para os cabeÃ§as de chave)` : ''}: ${nomeRodadaMata(0, log2(N))} atÃ© a final.`; }
  const q = c.nGrupos * c.classificam, N = nextPow2(Math.max(q, 2));
  const tam = Math.floor(T / c.nGrupos), extra = T % c.nGrupos;
  return `${c.nGrupos} grupo${c.nGrupos > 1 ? 's' : ''} de ${tam}${extra ? ` ou ${tam + 1}` : ''} times, por cotas e cartÃµes. Classificam ${c.classificam} por grupo (${q}) â†’ ${nomeRodadaMata(0, log2(N))}${N > q ? ` (${N - q} folga${N - q > 1 ? 's' : ''})` : ''} quando vocÃª fechar a fase de grupos.`;
}
function htmlConfig() {
  ...
  const stepper = (k, min, max) => `<div class="cx-step2"><button data-cx="cfgStep" data-k="${k}" data-d="-1" aria-label="Diminuir">âˆ’</button><output>${c[k]}</output><button data-cx="cfgStep" data-k="${k}" data-d="1" aria-label="Aumentar">+</button></div>`;
  ...
  const corpo = `<div class="cx-f"><label for="cx-c-titulo">Nome da copa</label><input class="cx-in" id="cx-c-titulo" maxlength="60" value="${esc(d.titulo)}" data-cxi="cfgTexto" data-k="titulo"></div>
    <div class="cx-row"><div class="cx-f"><label for="cx-c-sub">SubtÃ­tulo</label><input class="cx-in" id="cx-c-sub" maxlength="60" value="${esc(d.subtitulo)}" data-cxi="cfgTexto" data-k="subtitulo"></div>
    <div class="cx-f"><label for="cx-c-logo">Ãcone (emoji ou imagem)</label><div class="cx-photo"><input class="cx-in" id="cx-c-logo" maxlength="300" value="${esc(d.logo)}" data-cxi="cfgTexto" data-k="logo" placeholder="ðŸ†"><button class="cx-btn sm" type="button" data-cx="upload" data-alvo="cx-c-logo" data-pasta="copa-logos">${ico('upload')}</button></div></div></div>
    <div class="cx-lbl" style="margin-bottom:8px">Formato</div><div class="cx-opts">${fmt('grupos', 'Fase de grupos + mata-mata', 'Estilo Copa do Mundo: grupos, depois eliminatÃ³rias atÃ© a final.')}${fmt('mata', 'Mata-mata direto', 'Chave eliminatÃ³ria desde o comeÃ§o (com folga se o nÃºmero de times nÃ£o for potÃªncia de 2).')}${fmt('pontos', 'Pontos corridos', 'Estilo BrasileirÃ£o: todos contra todos, o lÃ­der Ã© o campeÃ£o.')}</div>
    ...
    ${c.formato !== 'pontos' ? tog('terceiro', 'Disputa de 3Âº lugar', 'Os perdedores das semifinais jogam entre si.') : ''}
    ...
    ${estr ? `<div class="cx-warn bad" style="margin-top:14px">${ico('alert')}<div>Mudar o formato ou os grupos <b>refaz o sorteio</b> (volta pra fase de times/cotas). Os times continuam na copa, com as cotas e cartÃµes que jÃ¡ tiverem.</div></div>` : ''}`;
...
async function salvarConfig() {
  ...
  if (estr) {
    ...
    if (!await confirmar({ titulo: 'Refazer o sorteio?', msg: tem ? 'O sorteio serÃ¡ desfeito e todos os jogos e resultados serÃ£o apagados.' : 'O sorteio serÃ¡ desfeito e vocÃª precisarÃ¡ sortear de novo.', ok: 'Refazer', perigo: true })) return;
  }
  const r = await mutar(E => {
    E.titulo = titulo; E.subtitulo = d.subtitulo.trim(); E.logo = d.logo.trim() || 'ðŸ†';
  ...
  }, { rot: 'ConfiguraÃ§Ã£o', perguntar: false });
...
/* â•â•â•â•â•â•â•â•â• SORTEIO â•â•â•â•â•â•â•â•â• */
function abrirSorteio() {
  ...
  if (temEstrutura(E) && E.jogos.some(temResultado)) {
    confirmar({ titulo: 'Refazer o sorteio?', msg: 'Todos os jogos e resultados atuais serÃ£o apagados.', ok: 'Refazer', perigo: true }).then(ok => { if (ok) rodar(); });
  } else rodar();
}
function htmlSorteio() {
  ...
  if (s.tipo === 'g') {
    ...
    corpo = `<p class="cx-hint" style="margin:0 0 14px">CabeÃ§as de chave (â˜…) ficam em grupos diferentes. Se quiser trocar alguÃ©m de grupo, use o seletor ao lado do nome.</p><div class="cx-draw">${s.grupos.map((g, gi) => `<div class="cx-dg" style="--gc:${corGrupo(gi)}"><h5><span class="cx-gbadge">${esc(g.id)}</span>Grupo ${esc(g.id)}<span class="cx-hint" style="margin-left:auto">${g.ids.length}</span></h5><ul>${g.ids.map((id, i) => { const t = timePorId(id); return `<li style="--i:${gi * 4 + i}">${escudo(t)}<span>${t.cab ? 'â˜… ' : ''}${esc(t.n)}</span><select aria-label="Mover ${esc(t.n)} de grupo" data-cxi="sortMove" data-id="${esc(id)}">${s.grupos.map(x => `<option ${x.id === g.id ? 'selected' : ''}>${esc(x.id)}</option>`).join('')}</select></li>`; }).join('')}</ul></div>`).join('')}</div>`;
  } else {
    const T = s.seeds.length, N = nextPow2(Math.max(T, 2));
    sub = 'Chaveamento';
    corpo = `<p class="cx-hint" style="margin:0 0 14px">A ordem abaixo Ã© a posiÃ§Ã£o na chave (1 = cabeÃ§a de chave). ${N > T ? `Com ${T} times numa chave de ${N}, os ${N - T} primeiros ganham folga na 1Âª rodada.` : ''} Use as setas para ajustar.</p><ol class="cx-seeds">${s.seeds.map((id, i) => { const t = timePorId(id); return `<li style="--i:${i}"><span class="n">${i + 1}</span>${escudo(t)}<span class="t">${t.cab ? 'â˜… ' : ''}${esc(t.n)}</span>${i < N - T ? '<span class="cx-tag">Folga</span>' : ''}<button class="cx-ib" data-cx="seedMove" data-i="${i}" data-d="-1" ${i === 0 ? 'disabled style="opacity:.3"' : ''} aria-label="Subir">${ico('up')}</button><button class="cx-ib" data-cx="seedMove" data-i="${i}" data-d="1" ${i === s.seeds.length - 1 ? 'disabled style="opacity:.3"' : ''} aria-label="Descer">${ico('down')}</button></li>`; }).join('')}</ol>`;
  }
...
/* â•â•â•â•â•â•â•â•â• TEMA â•â•â•â•â•â•â•â•â• */
function abrirTema() {
  if (!S.admin) return;
  fecharTema();
...
function htmlTema() {
  ...
  const nomes = { bg: 'Fundo', surf: 'CartÃµes', text: 'Texto', accent: 'Destaque', accent2: 'Destaque 2' };
  ...
  const cores = T.preset === 'portal' ? '<p class="cx-hint">Este tema usa as cores do prÃ³prio Portal (claro/escuro). Para escolher cores livres, selecione outro tema ou mexa em uma cor abaixo.</p>' : '';
  ...
  return `<div class="cx-mh"><div style="flex:1"><small>Personalizar</small><h3>Tema da copa</h3></div><button class="cx-ib" data-cx="temaFechar" aria-label="Fechar">${ico('x')}</button></div>
    ...
    <div class="cx-f"><label>Cantos arredondados Â· <span id="cx-v-radius">${T.radius}px</span></label><input class="cx-range" type="range" min="0" max="24" step="1" value="${T.radius}" data-cxi="temaRange" data-k="radius"></div>
    <div class="cx-f"><label>Brilho dos efeitos Â· <span id="cx-v-glow">${T.glow}%</span></label><input class="cx-range" type="range" min="0" max="140" step="5" value="${T.glow}" data-cxi="temaRange" data-k="glow"></div>
    <button type="button" class="cx-tog ${T.fx ? 'on' : ''}" data-cx="temaFx" style="background:none;border:0;color:inherit;font:inherit;text-align:left;width:100%"><span class="sw"></span><span><b>AnimaÃ§Ãµes</b><span class="d">TransiÃ§Ãµes, brilho e confete. Desligue se preferir tudo parado.</span></span></button>
    <button class="cx-btn blk" style="margin-top:14px" data-cx="temaPadrao">${ico('undo')}Restaurar padrÃ£o</button></div>
    <div class="cx-mf"><span class="cx-hint" style="flex:1">As mudanÃ§as sÃ£o salvas sozinhas e todo mundo vÃª o mesmo tema.</span><button class="cx-btn pri" data-cx="temaFechar">Pronto</button></div>`;
}
...
function abrirMais() {
  ...
  const itens = [
    ...
    !S.meta.ativo ? it('tornarAtivaAtual', 'star', 'Tornar esta a copa vigente', 'Ã‰ a que aparece para todo mundo') : '',
    V.campeao ? it('historico', 'book', 'Registrar campeÃ£ no histÃ³rico', 'Adiciona em "CampeÃµes por ediÃ§Ã£o"') : '',
    E.gruposFechados ? it('reabrirGrupos', 'undo', f === 'pontos' ? 'Reabrir temporada' : 'Reabrir fase de grupos', f === 'pontos' ? 'Tira a campeÃ£, volta a aceitar cotas/cartÃµes' : 'Apaga o mata-mata sorteado; cotas e grupos continuam') : '',
    E.jogos.length ? it('zerar', 'refresh', 'Zerar resultados do mata-mata', 'MantÃ©m o chaveamento, limpa os placares') : '',
    ...
    it('excluirAtual', 'trash', 'Excluir esta copa', 'NÃ£o dÃ¡ para desfazer', 'bad'),
  ].filter(Boolean).join('');
  abrirModal(moldura({ titulo: 'Mais opÃ§Ãµes', cls: 'sm', corpo: `<div class="cx-menu">${itens}</div>` }), { kind: 'mais', foco: false });
}
function modalCampea() {
  ...
  abrirModal(`<div class="cx-modal sm"><div class="cx-win"><div class="cx-conf">${conf}</div>${escudo(t)}<small>${S.E.cfg.formato === 'pontos' ? 'CampeÃ£ do campeonato' : 'CampeÃ£ da copa'}</small><h3>${esc(t.n)}</h3><p>${esc(S.E.titulo)}</p><div style="display:flex;gap:8px;justify-content:center;flex-wrap:wrap;position:relative"><button class="cx-btn" data-cx="fechar">Fechar</button>${S.admin ? `<button class="cx-btn pri" data-cx="historico">${ico('book')}Registrar no histÃ³rico</button>` : ''}</div></div></div>`, { kind: 'campea', foco: false });
}
async function registrarHistorico() {
  const t = S.V.campeao && timePorId(S.V.campeao); if (!t) return;
  if (typeof sb === 'undefined') return avisar('IndisponÃ­vel neste ambiente.', 'err');
  const ano = (String(S.E.subtitulo).match(/(20\d{2})/) || [])[1] ? +String(S.E.subtitulo).match(/(20\d{2})/)[1] : new Date().getFullYear();
  if (typeof allCopaEdicoes !== 'undefined' && allCopaEdicoes.some(e => (e.tipo || 'copa') === 'copa' && e.ano === ano && e.equipe_campea === t.n && e.titulo === S.E.titulo)) return avisar('Esta campeÃ£ jÃ¡ estÃ¡ no histÃ³rico.', 'err');
  if (!await confirmar({ titulo: 'Registrar no histÃ³rico', msg: `Adicionar "${t.n}" em "CampeÃµes por ediÃ§Ã£o" (${ano})?`, ok: 'Registrar' })) return;
  ...
  if (error) return avisar('NÃ£o foi possÃ­vel registrar: ' + error.message, 'err');
  avisar('CampeÃ£ registrada no histÃ³rico.');
  try { const r = await sb.from('portal_copa_edicoes').select('*').order('ano', { ascending: false }); if (r.data && typeof allCopaEdicoes !== 'undefined') { allCopaEdicoes.length = 0; r.data.forEach(x => allCopaEdicoes.push(x)); } if (typeof renderCopaTimeline === 'function') renderCopaTimeline(); } catch (e) { /* atualizar a lista Ã© opcional */ }
}

/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
   AÃ‡Ã•ES, EVENTOS, TEMPO REAL E ENTRADA (montar)
   â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */
...
const ACOES = {
  ...
  async gol(el) {
    ...
    if (r && r.reaberto) avisar('Jogo reaberto: informe os pÃªnaltis para encerrar de novo.');
  },
  async jogoSt(el) {
  ...
  /* fase de grupos: cotas, cartÃµes, mover de grupo, fechar/reabrir */
  editCotas(el) { abrirEditarCotas(el.dataset.id); },
  cotCartaoAm(el) {
    const id = S.cotasAlvo; if (!id) return;
    mutar(E => ajustarCartaoAmarelo(E, id, +el.dataset.d), { rot: 'CartÃ£o amarelo', coal: 'am:' + id, perguntar: false }).then(() => repintarEditarCotas());
  },
  cotCartaoVerm() {
    const id = S.cotasAlvo; if (!id) return;
    mutar(E => alternarCartaoVermelho(E, id), { rot: 'CartÃ£o vermelho', perguntar: false }).then(() => repintarEditarCotas());
  },
  fecharGrupos: () => abrirFecharGrupos(),
  fecharGruposOk: () => confirmarFecharGrupos(),
  reabrirGrupos() {
    fecharModal(S.modais.find(m => m.dataset.kind === 'mais'));
    confirmar({ titulo: S.E.cfg.formato === 'pontos' ? 'Reabrir temporada?' : 'Reabrir fase de grupos?', msg: S.E.cfg.formato === 'pontos' ? 'Volta a aceitar ajustes de cotas/cartÃµes sem campeÃ£ definida. VocÃª encerra de novo quando quiser.' : 'O mata-mata jÃ¡ sorteado Ã© apagado. Cotas, cartÃµes e os grupos continuam como estÃ£o.', ok: 'Reabrir', perigo: true })
  ...
  async resetSorteio() {
    fecharModal(S.modais.find(m => m.dataset.kind === 'mais'));
    if (!await confirmar({ titulo: S.E.cfg.formato === 'pontos' ? 'Reiniciar campeonato' : 'Refazer sorteio', msg: 'O sorteio e todos os jogos e resultados serÃ£o apagados. Os times continuam na copa.', ok: 'Apagar e refazer', perigo: true })) return;
...
async function excluirCopa(id) {
  ...
  if (!await confirmar({ titulo: 'Excluir copa', msg: `Excluir "${c ? c.titulo : 'esta copa'}" com todos os times, jogos e resultados? NÃ£o dÃ¡ para desfazer.`, ok: 'Excluir', perigo: true })) return;
  try {
    ...
    avisar('Copa excluÃ­da.');
  } catch (e) { avisar(e.message, 'err'); }
}
function abrirNovaCopa() {
  fecharModal(S.modais.find(m => m.dataset.kind === 'copas'));
  const ovl = abrirModal(moldura({ titulo: 'Nova copa', cls: 'sm', corpo: `<div class="cx-f"><label for="cx-nc">Nome da copa</label><input class="cx-in" id="cx-nc" maxlength="60" value="Copa GR ${new Date().getFullYear()}" autocomplete="off"></div><p class="cx-hint">VocÃª escolhe times, formato e tema logo em seguida. A copa sÃ³ aparece para os colaboradores quando for a vigente${S.lista.some(c => c.ativo) ? ' (hoje jÃ¡ existe uma vigente: a nova fica como rascunho atÃ© vocÃª trocar)' : ''}.</p>`, rodape: `<button class="cx-btn ghost" data-cx="fechar">Cancelar</button><button class="cx-btn pri" data-cx="criarCopa">Criar</button>` }), { kind: 'nova' });
...
const ECH = { // evento "change" (ao confirmar)
  ...
  pen(el) {
    ...
    mutar(E => definirJogo(E, id, l === 'a' ? { pa: v } : { pb: v }), { rot: 'PÃªnaltis', coal: 'pen:' + id });
  },
...
function ligarEventos() {
  ...
  // brilho que acompanha o mouse nos cartÃµes
...
function assinar() {
  storeAtual().assinar((ev, novo, antigo) => {
    if (!S.raiz) return;
    if (ev === 'DELETE') { if (antigo && antigo.id === S.id) { avisar('Esta copa foi excluÃ­da por outra pessoa.', 'err'); montar(); } else atualizarLista(); return; }
    if (!novo || novo.id !== S.id) {
      // outra copa mudou; se virou a vigente e sou sÃ³ espectador, troca para ela
      if (novo && novo.ativo && !S.admin) montar(); else atualizarLista();
      return;
    }
    if (novo.estado === undefined) { recarregarDoServidor(false); return; }
    if (novo.rev <= S.rev) return; // eco da minha prÃ³pria gravaÃ§Ã£o
...
async function abrirCopa(id) {
  ...
  if (!row) throw new Error('Copa nÃ£o encontrada.');
...
function sair() {
  clearTimeout(S.tSalvar);
  if (S.admin && S.salvo === 'sujo') salvarAgora(); // nÃ£o perde a Ãºltima alteraÃ§Ã£o ao trocar de aba
  try { storeAtual().desassinar(); } catch (e) { /* jÃ¡ solto */ }
